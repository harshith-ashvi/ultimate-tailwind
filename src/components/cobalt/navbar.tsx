  ...
  return (
    <div className="flex items-center justify-between px-4">
      ...
      <div className="flex items-center gap-4">
        <Link href="/cobalt" className="font-sm text-sm text-white">
          Blog
        </Link>
        <button className="relative cursor-pointer rounded-4xl border border-neutral-700 bg-neutral-800 px-4 py-2 text-sm text-neutral-50">
